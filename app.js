...
headDropdown.addEventListener('change', () => {
    ...
    console.log('changing head selection', headDropdown.value);
...
middleDropdown.addEventListener('change', () => {
    ...
    console.log('changing middle selection', middleDropdown.value);
...
bottomDropdown.addEventListener('change', () => {
    ...
    console.log('changing bottom selection', bottomDropdown.value);
...
function displayCatchphrases() {
    ...
    for (let catchphraseText of catchphrases) {
        console.log(catchphrases);
        const phrase = document.createElement('div');
        // create an HTML element with the catchphrase as its text content
        phrase.textContent = catchphraseText;
