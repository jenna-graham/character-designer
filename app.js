...
let catchphrasesCount = [];


headDropdown.addEventListener('change', () => {
    // get the value of the head dropdown
    console.log('changing head selection');
...
middleDropdown.addEventListener('change', () => {
    ...
    console.log('changing middle selection');
...
bottomDropdown.addEventListener('change', () => {
    ...
    console.log('changing bottom selection');
...
catchphraseButton.addEventListener('click', () => {
    ...
    catchphrasesCount.push(catchphrasesEl.value);
    console.log(catchphrasesCount);
